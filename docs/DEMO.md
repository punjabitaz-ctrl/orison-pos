...
5. Refund a sale (History). It needs a manager's approval, and services cannot be refunded.
...
3. Receive the purchase order that is on its way (Purchases). It is on 5% trade terms with tax on the invoice, so the dialog shows the stock and the tax separately and what the delivery will be owed. Then pay **Swift Supplies**, who are owed $110, all of it overdue: tap the supplier, see their statement, and **Record payment** by bank transfer or cheque.
