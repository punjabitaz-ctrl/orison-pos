...
export const ACTION_GROUPS = [
  ...
  { label: N_('People and access'), actions: [
    ...
    { id: 'expense.record', label: N_('Running costs recorded') },
    { id: 'expense.void', label: N_('Running costs voided') },
    { id: 'cash.banked', label: N_('Cash banked') },
    { id: 'cash.banked_void', label: N_('Bank deposits voided') },
