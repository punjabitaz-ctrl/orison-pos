...
- **PDF beside every CSV**: the books (P&L + trial balance), reports, stock health, running costs, a pay run, customers, purchases, repairs and products — translated, laid out, and printable in any language, with no PDF library.
...
npm run test:client   # client unit tests via node:test + fake-indexeddb (639 checks)
