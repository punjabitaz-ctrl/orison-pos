...
```bash
npm test              # backend logic vs an in-memory Apps Script mock (1295 checks)
npm run test:client   # client unit tests via node:test + fake-indexeddb (602 checks)
npm run test:demo     # the demo: emulator, sample shop, site build (38 checks)
